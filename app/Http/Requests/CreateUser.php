...
class CreateUser extends FormRequest
{
    ...
    public function messages()
    {
      return [
          ...
          'image.file' => 'Errors during picture upload, please try again',
          'image.image' => 'Picture extensions allowed are: jpeg, jpg, png',
          'image.max' => 'Picture exceeds maximum size of 2MB',
