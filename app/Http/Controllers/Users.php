...
class Users extends Controller
{
    ...
    public function checkUserExistence(CheckUserExistence $request)
    {
        $client = new Client();
        return $client->post(
          'http://46.101.93.56/api/v2/check_user_existence',
    ...
    public function checkSystemExistence(CheckSystemExistence $request)
    {
      $client = new Client();
      return $client->post(
        'http://46.101.93.56/api/v2/check_system_existence',
        array('body' => $request->all())
      );
      //   $user = null;
      //   $token = null;
    ...
    {
        $client = new Client();
        return $client->get('http://46.101.93.56/api/v2/account_detail');
        // $user = Auth::user();
    ...
    public function updateAccountDetail(Request $request)
    {
        $client = new Client();
        return $client->post(
          'http://46.101.93.56/api/v2/update_account_detail',
          array('body' => $request->all())
        );
        // $id = Auth::id();
    ...
    {        
        $client = new Client();
        return $client->post(
          'http://46.101.93.56/api/v2/update_subscription',
          array('body' => $request->all())
        );
